...
# puts "Seeding games..."
# game1 = Game.create(team1_name: "lakers", team1_score: 0, team2_name: "hornets", team2_score: 0, game_status: false, winner: false, sports: "basketball")
# game2 = Game.create(team1_name: "heats", team1_score: 0, team2_name: "bucks", team2_score: 0, game_status: false, winner: false, sports: "basketball")
